...
<head>
    ...
    <title>Edit Fun Fact | MUA Admin</title>
        ...
        <div class="container pt-4">
            <div class="card shadow-0 border">
                <div class="card-header border-bottom py-3">
                    <h5 class="mb-0"><strong><i class="fas fa-edit me-2"></i>Edit Fun Fact</strong></h5>
                </div>
                <div class="card-body">
                
                    <form method="POST" action="{{ route('admin.funfact.update', $funfact->id_funfact) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input id="emoji" name="emoji" type="text" class="form-control"
                                value="{{ old('emoji', $funfact->emoji) }}" required>
                        </div>
                        <div class="form-group">
                            <label for="headline">Headline</label>
                            <input id="headline" name="headline" type="text" class="form-control"
                                value="{{ old('headline', $funfact->headline) }}" required>
                        </div>
                        <div class="form-group">
                            <label for="angka">Angka</label>
                            <input id="angka" name="angka" type="text" class="form-control"
                                value="{{ old('angka', $funfact->angka) }}" required>
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi</label>
                            <input id="deskripsi" name="deskripsi" type="text" class="form-control"
                                value="{{ old('deskripsi', $funfact->deskripsi) }}" required>
                        </div>
