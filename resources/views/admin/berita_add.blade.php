...
<head>
    ...
    <title>Tambah Berita - Admin MUA</title>
    <!-- Font Awesome -->
    ...
    <main style="margin-top: 76px;">
        <div class="container pt-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0 text-success fw-bold"><i class="bi bi-plus-circle"></i> Tambah Berita</h2>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="deskripsi" rows="6" class="form-control @error('deskripsi') is-invalid @enderror"
                                    placeholder="Tuliskan deskripsi lengkap berita..." required>{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="lokasi"
                                    ...
                                    value="{{ old('lokasi') }}" placeholder="Contoh: Pantai Indah Kapuk" required>
                                @error('lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="peserta"
                                    ...
                                    value="{{ old('peserta') }}" placeholder="Contoh: 50 Relawan" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mt-3 d-none" id="previewContainer">
                                    <label class="form-label d-block text-muted small">Preview Gambar:</label>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-4"><input type="text" name="tag1" class="form-control"
                                            value="{{ old('tag1') }}" placeholder="Tag 1 (Contoh: Lingkungan)"
                                            required></div>
                                    <div class="col-md-4"><input type="text" name="tag2" class="form-control"
                                            value="{{ old('tag2') }}" placeholder="Tag 2 (Contoh: Sosial)" required>
                                    </div>
                                    <div class="col-md-4"><input type="text" name="tag3" class="form-control"
                                            value="{{ old('tag3') }}" placeholder="Tag 3 (Contoh: Edukasi)"
                                            required></div>
                                </div>
                            </div>
