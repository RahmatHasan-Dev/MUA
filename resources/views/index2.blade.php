...
<head>
    ...
    <title>Beranda Admin | MUA - Menadah Untuk Alam</title>
    <link rel="stylesheet"
...
<body>
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <p>
                Kelola donasi dan pantau perkembangan konservasi alam Indonesia dari sini.
            </p>
            <a href="{{ route('admin.dashboard') }}" class="btn-cta btn-cta-light">
